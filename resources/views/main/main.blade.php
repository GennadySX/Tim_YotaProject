...
@section('main')
        ...
        <div class="hero_slider_container">
            ...
            <div class="owl-carousel owl-theme hero_slider">
                ...
                <div class="owl-item hero_slider_item item_1 d-flex flex-column align-items-center justify-content-center">
                    <span>by</span>
                    <span><img src="{{asset('tim/images/colorlib.png')}}" alt=""></span>
                    <span>GO!</span>
            ...
            <div class="row fill_height">
                ...
                <div class="col-lg-6 v_slider_section_image">
                    <div class="v_slider_image">
                        <img src="{{asset('tim/images/v_slider_section.jpg')}}" alt="">
                    </div>
                </div>
                            ...
                            <div class="v_slider_item">
                                ...
                                <div class="person d-flex flex-row">
                                    <div class="person_image">
                                        <img src="{{asset('tim/images/person_1.png')}}" alt="">
                                    </div>
            ...
            <div class="row features_row">
                ...
                <div class="col-lg-4 d-flex flex-column align-items-center order-lg-2 order-1">
                    <div class="features_image">
                        <img src="{{asset('tim/images/features.png')}}" alt="">
                    </div>
    ...
    <div class="cta">
        <div class="cta_background" style="background-image:url({{asset('tim/images/cta_background.jpg')}})"></div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 order-lg-2 order-1">
                    <div class="cta_image d-flex flex-column justify-content-end">
                        <img src="{{asset('tim/images/cta.png')}}" alt="image by https://unsplash.com/@heysupersimi">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-5 text-lg-right text-center">
                    <div class="text_line_image">
                        <img src="{{asset('tim/images/line.jpg')}}" alt="">
                    </div>
                </div>
